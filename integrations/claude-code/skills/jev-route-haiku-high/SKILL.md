...
# JEV route: haiku-high

This skill exists only to pin the model for this turn (model: claude-haiku-4-5-20251001).

Reason and respond at a "high" effort level: reason thoroughly, consider edge cases and alternative approaches before acting.
